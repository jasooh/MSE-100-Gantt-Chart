...
const GanttChart: React.FC = () => {
    ...
    const rows = [
        ...
        new Date(2024, 9, 1), new Date(2024, 9, 6), null, 50, null],
        ['Stage_2', 'Determine Possible Features',
        new Date(2024, 9, 1), new Date(2024, 9, 3), null, 80, null],
        ['Stage_3', 'Finalize Required Features & Details',
        new Date(2024, 9, 3), new Date(2024, 9, 6), null, 50, null],
        ['Stage_5', 'Prototyping Features',
        new Date(2024, 9, 6), new Date(2024, 9, 25), null, 0, null],
        ...
        ['Stage_8', 'Fianl Revisions & Submission',
